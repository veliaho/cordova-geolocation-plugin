...
public class GeolocationService extends BackgroundService {
    ...
    private static final int MIN_TIME = 5000;  // location changes must be at least 5 seconds apart
    private static final int MIN_DIST = 0; // location changes are not filtered
